...
class CityServiceTests: XCTestCase {
    ...
    func testGetCityPreviewsSuccess() {
        ...
        storageMock.setupGetObjects(objects: [
            CityStored(id: "1111", name: "Test", image: "", spentTime: 123, comfortRating: 0, greenRating: 0, buildings: [], history: [])
        ])
    ...
    func testGetCurrentCity() {
        ...
        storageMock.setupGetObjects(objects: [CityStored(id: cityId, name: "December", image: "eee", spentTime: 123, comfortRating: 0.0, greenRating: 0.1, buildings: [], history: [])])
